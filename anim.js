...
var lyricsData = [
  ...
  { text: "Chocamo' en el trayecto", time: 24 },
  { text: "Con tu alma es la que yo conecto", time: 26 },
  { text: "Tranquila, no tiene que ser perfecto, no", time: 29 },
  { text: "Aquí no existe el pecado", time: 34 },
  { text: "Y equivocarse es bonito", time: 37 },
  { text: "Los errore' son placere'", time: 40 },
